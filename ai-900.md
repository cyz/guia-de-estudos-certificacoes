...
> _Obs: focar em materiais em inglês, se possível. Como o exame será em inglês, é interessante se acostumar com os termos._
...
> Módulo no MSLearn [inglês](https://docs.microsoft.com/en-us/learn/paths/get-started-with-artificial-intelligence-on-azure/) | [português](https://docs.microsoft.com/pt-br/learn/paths/get-started-with-artificial-intelligence-on-azure/)

> **Dica:** Lembrar da parte de Ética em AI – qual princípio para cada tipo de diretriz
...
> Módulo no MSLearn [inglês](https://docs.microsoft.com/en-us/learn/paths/create-no-code-predictive-models-azure-machine-learning/) | [português](https://docs.microsoft.com/pt-br/learn/paths/create-no-code-predictive-models-azure-machine-learning/)

> **Dicas:**
>
> - Lembrar qual tipo de algoritmo serve para cada necessidade e quais métricas para avaliar cada tipo de modelo (Classificação, Regressão, Agrupamento)
> - Lembrar do Azure Machine Learning e como utilizar (criação de recursos computacionais, etc)
...
- [ ] identificar recursos e rótulos (_labels_) em um conjunto de dados para aprendizado de máquina
...
## Descrever os recursos das cargas de trabalho de visão computacional no Azure (15-20%)

> Módulo no MSLearn [inglês](https://docs.microsoft.com/en-us/learn/paths/explore-computer-vision-microsoft-azure/) | [português](https://docs.microsoft.com/pt-br/learn/paths/explore-computer-vision-microsoft-azure/)

> **Dicas:**
>
> - Lembrar quais são as possibilidades de cada componente de análise de imagem
> - Lembrar o que preciso dentro do Azure para rodar cada serviço (Custom Visual tem o endpoint de cadastro e predição, Key para chamada do endpoint, etc)
...
> Módulo no MSLearn [inglês](https://docs.microsoft.com/en-us/learn/paths/explore-natural-language-processing/) | [português](https://docs.microsoft.com/pt-br/learn/paths/explore-natural-language-processing/)

> **Dicas:**
>
> - Lembrar das possibilidades de análise de texto (key phrases, sentimento, entity recognition, tradução, etc), speech (fala), LUIS (processamento de linguagem natural, entendimento de Declarações/Utterances, Entidades/Entities e Intenções/Intents)
> - Lembrar que cada serviço serve a um propósito e podemos combiná-los para uma experiência completa (ex. Tradução + LUIS para traduzir e reconhecer intenção transformando em ações)
...
> Módulo no MSLearn [inglês](https://docs.microsoft.com/en-us/learn/paths/explore-conversational-ai/) | [português](https://docs.microsoft.com/pt-br/learn/paths/explore-conversational-ai/) _- obs: material superficial_ </br>
> Material complementar [parte 1](https://docs.microsoft.com/en-us/learn/paths/create-conversational-ai-solutions/) | [parte 2](https://docs.microsoft.com/en-us/learn/modules/responsible-bots/) | [parte 3](https://docs.microsoft.com/en-us/learn/modules/design-bot-conversation-flow/) | [parte 4](https://docs.microsoft.com/en-us/learn/modules/create-and-publish-a-luis-model/)

> **Dicas:**
>
> - Lembrar que AI Conversacional diz respeito a BOTs (como funciona QnA Maker para criar um simples BOT de pergunta e resposta, BOT Framework para criação de BOTs avançados Personal Digital Assistant e Voice Assistant)
> - Lembrar que também pode ser integrado com outros serviços cognitivos (principalmente de processamento de linguagem natural para criar uma experiência completa
